...
if __name__ == "__main__":
    newick_tree = rapidnj.RNJ('data/89_Adeno_E3_CR1.phy').neighbour_joining()
    #newick_tree = rapidnj.RNJ('data/10.phy').neighbour_joining() # (((8_Q9DK06_, 9_Q9DK03_), ((4_VGLY_PI, 5_O11998_), (6_O11999_, 7_O11997_))), (2_Q9YTW9_, 3_Q9YTW8_), (0_Q9YTX1_, 1_O90423_));
