...
#    build_table()
    ...
    # Comparing trees for proj 5.
    def proj5comp(file1, file2):
        o = Robinson_Foulds_distance(file1, file2)
        print(o.distance)


    print('and the distance is:')
    proj5comp('data/rfdist/compare_sanity/89kobellong.newick', 'data/rfdist/compare_sanity/out_qt_89_Adeno_E3_CR1.phy.newick')
